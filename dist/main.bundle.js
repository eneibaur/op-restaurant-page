...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://op-restaurant-page/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://op-restaurant-page/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\n\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://op-restaurant-page/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\n\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://op-restaurant-page/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\n\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://op-restaurant-page/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/pexels-andrea-piacquadio-3769999.jpg */ \"./src/img/pexels-andrea-piacquadio-3769999.jpg\");\n\n\nfunction homePage(){\n\n    const pageContents = document.createElement(`div`);\n    pageContents.classList.add('tab-menus');\n\n    const paraOne = document.createElement(`h1`);\n    paraOne.textContent = \"Hello! I'm Jackie!\"\n\n    const ownerPhoto = new Image();\n    ownerPhoto.src = _img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__;\n    ownerPhoto.classList.add('profile-photo');\n\n    const paraTwo = document.createElement('h2');\n    paraTwo.textContent = \"I've been making pizzas for my family since I was little - and for Seattle since I was a teenager!\"\n\n    pageContents.appendChild(paraOne);\n    pageContents.appendChild(ownerPhoto);\n    pageContents.appendChild(paraTwo);\n\n    return pageContents;\n    \n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (homePage);\n\n//# sourceURL=webpack://op-restaurant-page/./src/home.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./img/pexels-andrea-piacquadio-3769999.jpg */ \"./src/img/pexels-andrea-piacquadio-3769999.jpg\");\n\n\nfunction menuPage(){\n    const pageContents = document.createElement(`div`);\n    pageContents.classList.add('tab-menus');\n    pageContents.id = 'menu';\n\n    function menuItem(imglink, itemname) {\n        const slice = document.createElement('div');\n        slice.classList.add('pizza-grid');\n        \n        const slicePhoto = new Image();\n        slicePhoto.src = imglink;\n        slicePhoto.classList.add('slice-graphic');\n\n        const sliceName = document.createElement('p')\n        sliceName.textContent = itemname;\n\n        slice.appendChild(sliceName);\n        slice.appendChild(slicePhoto);\n\n        return slice;\n    }\n\n    const pepperoni = menuItem(_img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__, 'Pepperoni');\n    const cheese = menuItem(_img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__, 'Cheese');\n    const meat = menuItem(_img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__, \"Meat Lover's\");\n    const supreme = menuItem(_img_pexels_andrea_piacquadio_3769999_jpg__WEBPACK_IMPORTED_MODULE_0__, \"Supreme\");\n\n    pageContents.appendChild(pepperoni);\n    pageContents.appendChild(cheese);\n    pageContents.appendChild(meat);\n    pageContents.appendChild(supreme);\n\n    return pageContents;\n    \n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (menuPage);\n\n//# sourceURL=webpack://op-restaurant-page/./src/menu.js?");

/***/ }),

/***/ "./src/img/pexels-andrea-piacquadio-3769999.jpg":
/*!******************************************************!*\
  !*** ./src/img/pexels-andrea-piacquadio-3769999.jpg ***!
  \******************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"de964199a8435885b51f.jpg\";\n\n//# sourceURL=webpack://op-restaurant-page/./src/img/pexels-andrea-piacquadio-3769999.jpg?");

/***/ }),

/***/ "./src/img/pexels-narda-yescas-1566837.jpg":
/*!*************************************************!*\
  !*** ./src/img/pexels-narda-yescas-1566837.jpg ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"a9f53bdbddf8f5e06718.jpg\";\n\n//# sourceURL=webpack://op-restaurant-page/./src/img/pexels-narda-yescas-1566837.jpg?");
